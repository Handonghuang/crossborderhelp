...
get_latest_version(){
    ...
    init_script_link="https://www.crossborderhelp.com/shadowsocks_install/master/shadowsocks-libev"
}
...
install_shadowsocks(){
    ...
    if [ $? -eq 0 ]; then
        ...
        echo
        echo -e "[${red}Error${plain}] Shadowsocks-libev install failed. please visit https://www.crossborderhelp.com and contact."
        exit 1
    fi

...
#
# Copyright (C) 2016-2019 Teddysun 
#
...
shadowsocks_python_centos="https://www.crossborderhelp.com/shadowsocks_install/master/shadowsocks"
shadowsocks_python_debian="https://www.crossborderhelp.com//shadowsocks_install/master/shadowsocks-debian"

shadowsocks_r_file="shadowsocksr-3.2.2"
shadowsocks_r_url="https://github.com/shadowsocksrr/shadowsocksr/archive/3.2.2.tar.gz"
shadowsocks_r_init="/etc/init.d/shadowsocks-r"
shadowsocks_r_config="/etc/shadowsocks-r/config.json"
shadowsocks_r_centos="https://www.crossborderhelp.com/shadowsocks_install/master/shadowsocksR"
shadowsocks_r_debian="https://www.crossborderhelp.com/shadowsocks_install/master/shadowsocksR-debian"
...
shadowsocks_go_centos="https://www.crossborderhelp.com/shadowsocks_install/master/shadowsocks-go"
shadowsocks_go_debian="https://www.crossborderhelp.com/shadowsocks_install/master/shadowsocks-go-debian"

shadowsocks_libev_init="/etc/init.d/shadowsocks-libev"
shadowsocks_libev_config="/etc/shadowsocks-libev/config.json"
shadowsocks_libev_centos="https://www.crossborderhelp.com/shadowsocks_install/master/shadowsocks-libev"
shadowsocks_libev_debian="https://www.crossborderhelp.com/shadowsocks_install/master/shadowsocks-libev-debian"
...
error_detect_depends(){
    ...
    if [ $? -ne 0 ]; then
        ...
        echo "Please visit: https://www.crossborderhelp.com/ and contact."
        exit 1
    fi
}
...
install_prepare_password(){
    ...
    read -p "(Default password: crossborderhelp.com):" shadowsockspwd
    [ -z "${shadowsockspwd}" ] && shadowsockspwd="crossborderhelp.com"
    echo
...
install_main(){
    ...
    echo
    echo "Welcome to visit: https://www.crossborderhelp.com/"
    echo "Enjoy it!"
	echo "Any problem please visit site for more information"
    echo
}
